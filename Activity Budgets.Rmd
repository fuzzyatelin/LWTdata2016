...
ggpaired(fullbudget_pred,x="release",y="Means",fill="release") + theme_bw() + xlab("Release Stage") + ylab("Mean Hourly Count") + scale_fill_manual(values = c("skyblue3","skyblue3")) + theme(legend.position = "none")
```
